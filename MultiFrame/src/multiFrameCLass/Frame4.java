...
import models.KonversiMataUang;
...
public class Frame4 extends BaseFrame {
    ...
    public Frame4(MultiFrame multiFrame, String frameName) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Konverter Mata Uang");
    ...
    private void btnConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConvertActionPerformed
        double usd = Double.parseDouble(txtInput.getText());
        KonversiMataUang konsersiUang = new KonversiMataUang(usd);
        labelHasil.setText(String.valueOf(konsersiUang.convert()) + " IDR");
