...
public class Frame1 extends BaseFrame {
    ...
    public Frame1(MultiFrame multiFrame, String frameName) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Kalkulator Lingkaran");
    ...
    private void btnLuasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuasActionPerformed
        ...
        Calculator calc = new CalculatorLingkaran(r);
        labelHasil.setText(String.valueOf(calc.hitungLuas()));
    ...
    private void btnKelilingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKelilingActionPerformed
        double r = Double.parseDouble(txtInput.getText());
        Calculator calc = new CalculatorLingkaran(r);
        labelHasil.setText(String.valueOf(calc.hitungKeliling()));
